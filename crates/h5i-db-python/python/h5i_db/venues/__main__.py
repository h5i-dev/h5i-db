...
from ._archive import PMXT_LAYOUT, TELONEX_LAYOUT, discover, ingest_archive
from ._markets import MarketSpec, polymarket_markets_from_json, write_markets

_LAYOUTS = {"pmxt": PMXT_LAYOUT, "telonex": TELONEX_LAYOUT}
...
def main(argv: Optional[Sequence[str]] = None) -> int:
    ...
    db = Database(args.database, create=args.command in ("markets", "ingest"))
    try:
